const Info = `
  <div class="info">
    ...
    <div class="guide border-primary">
      ...
      ></div>
      <div class="berries">
        <div class="berry-row berries-normal border-primary space-top color-internal padded">
        ...
        <div class="berry-row berries-silver border-primary space-top color-internal padded">
        ...
        <div class="berry-row berries-golden border-primary space-top color-internal padded">
